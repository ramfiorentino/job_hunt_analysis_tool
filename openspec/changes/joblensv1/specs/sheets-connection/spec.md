...
- **THEN** the server returns a JSON array where each object contains the job listing's fields (Job Title, URL, Company, Salary, Contract, Keywords, Location, Remote Status, Description, and additional columns: Open Questions, Benefits, Industry, Company Size, Company Vibe, Latest Funding Round, Lead Source, Priority)
